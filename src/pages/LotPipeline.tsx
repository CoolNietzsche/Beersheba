          ...
          {PIPELINE.map(stage => {
            ...
            return (
              <div key={stage.key} style={{
                ...
                <span style={{ fontFamily: T.font.mono, fontSize: "0.58rem", letterSpacing: "0.12em", textTransform: "uppercase", color: stage.key === "exported" ? T.color.white : stage.color }}>
                  {stage.label}
                </span>
                <span style={{ fontFamily: T.font.display, fontSize: "1.6rem", fontWeight: 300, color: stage.key === "exported" ? T.color.white : stage.color, marginLeft: "auto", lineHeight: 1 }}>
                  {count}
                </span>
              </div>
            );
            ...
            return (
              <div key={stage.key} style={{
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "12px", paddingBottom: "10px", borderBottom: `1px solid ${stage.border}` }}>
                  <span style={{ fontFamily: T.font.mono, fontSize: "0.6rem", letterSpacing: "0.15em", textTransform: "uppercase", color: isExported ? T.color.forest : stage.color, fontWeight: 600 }}>
                    {stage.label}
                  </span>
                  <span style={{ fontFamily: T.font.display, fontSize: "1.3rem", fontWeight: 300, color: isExported ? T.color.forest : stage.color, lineHeight: 1 }}>
                    {lots.length}
                  </span>
                </div>
